...
public class Espectaculo {
	...
	public Espectaculo(String nombre, String descripcion, int duracionMin, int cantMinEspectadores,
			int cantMaxEspectadores, String url, float costo, Date fechaRegistro) {
		super();
		this.nombre = nombre;
	...
	public DtEspectaculo getData() {
		ArrayList<DtFuncion> data_funciones = new ArrayList<DtFuncion>();
		...
		if(this.funciones.isEmpty()) {
			...
			while (iterator.hasNext()) {
				...
				data_funciones.add(funcion.getData());
			}
		}

		DtEspectaculo newEspectaculo = new DtEspectaculo(nombre, 
										descripcion, 
										duracionMin, 
										cantMinEspectadores, 
										cantMaxEspectadores, 
