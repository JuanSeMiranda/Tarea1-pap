...
public class AltaUsuario extends JInternalFrame {
	...
	public void altaUsuarioAceptarActionPerformed() {
		if(checkFormulario()) {
			...
			try {
				this.icau.ingresarDatos(nickname, correo, nombre, apellido, fechanac);
	...
	private boolean checkFormulario() {
        ...
        if(textFieldNickname.getText().isBlank() || textFieldCorreo.getText().isBlank() || textFieldNombre.getText().isBlank() || textFieldApellido.getText().isBlank() || textFieldDia.getText().isBlank() || textFieldMes.getText().isBlank() || textFieldAnio.getText().isBlank() || (textFieldDescripcion.getText().isBlank() && rdbtnArtista.isSelected())) {
