...
public class AltaEspectaculo extends JInternalFrame {
	...
	public AltaEspectaculo(ICAltaEspectaculo icae) {
		...
		btnCancelar.setBounds(50, 270, 117, 25);
		...
		btnAceptar.setBounds(360, 270, 117, 25);
	...
	protected void altaEspectaculoAceptarActionPerformed(ActionEvent arg0) {
		if(verificarCampos()) {
			...
			try {
				...
				this.icae.ingresarDatos(nombre, descripcion, duracion, capMin, capMax, url, costo);
